...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "You can view its entirety as PDF towards the right (last updated 12/2025).",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-this-portfolio-was-launched",
          title: 'This portfolio was launched.',
          description: "",
          section: "News",},{id: "news-test-announcement-with-details",
          title: 'test announcement with details',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-development-of-a-remineralizing-and-antiomicrobial-composite-using-k18-isobornyl-acrylate-and-nanohydroxyapatite",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-experimental-validation-of-ml-predicted-dental-composite-formulations",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/huang_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%66%72%65%64%65%72%69%63%6B%68%75%61%6E%67%31@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/huangfrederick", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
